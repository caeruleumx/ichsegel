...
# Theoriewissen (Fragenkatalog)
http://www.tim.sf-ub.de/www2/trainer_online/sks/index.html

3er Buch, um erste inspiration für grob sortierung/ einteilung zu bekommen
## Schifffahrtsrecht
Seeverkehrsrecht
- Übersicht (F.1-4,59,60)
- Geltungsbereich (F.57,88-90)
Kollisionsverhütungsregeln
- Teil A (Allgemeines):
    - Aufbau der KRV (F.5,6)
    - allgemeine Bestimmungen der KVR (F.6,8-10,16)
- Teil B (Ausweich- und Fahrregeln):
    - Verhalten bei allen Sichtverhältnissen (F.11,24,35-37,45,25,46,53,72)
    - Fahrregeln für die Verkehrstrennungsgebiete (F.7,26,27,33,46)
    - Fahrzeuge, die einander in Sicht haben (F.38,39,42,44,40,41,32,48-51,31,43,49,51,41,44,45,50, +Seemanschaft 159-161)
    - Verhalten bei verminderter Sicht (F.28-30, +Wetter 77)
- Teil C (Lichter und Signalkörper)
    - Anwendung, Begriffe, Tragweite (F.17,48,49)
    - Maschinen- und Segelfahrzeuge (F.16,18,38-40,80)
    - Fischend, manövrierunfähig, -behindert (F.14-16,21-23,41,52,77,78)
    - Tiefgangbehindert und Lotsenfahrzeuge (F.12,47,52)

    + KVR&SeeSchStrO: Lichter,Signalkörper und Schallsignale
        - Licher der Fahrzeuge
        - Licher nach KVR
        - Lichter nach KVR oder SeeSchStrO (F.62 (F.))
        - Grenzkurse bestimmen
        - Verhalten bei Nacht
        - Signalkörper (aber relevant in Fragen)
        - Schallsignale (F.62,63)
- Teil D (Schall und Lichtsignale)
    - Schall- und Lichtsignale (F.31,32,48,51)
    - Schall-, Licht-, Notsignale; Befreiungen[Teil E] (F.19-21,52)
- Teil E (Befreiungen)
    - ?? siehe teil D letzter punkt
- Anlage IV (Notzeichen)
    - Notzeichen, Flaggensignale
    - Signalflaggen
Seeschiffahrtsstraßenordnung
- Allgemeine Bestimmungen
    - Geltungsbereich (F.25,53,57,58)
    - Begriffsbestimmungen (F.13)
    - Grundregeln (F.Nav-35,Recht-55,83,84)
    - Verantwortlichkeit (F.56)
    - Grundsätze, Rechtsfahrgebot (F.72,73)
- Fahrregeln (F.)
    - Überholen, Begegnen (F.74)
    - Vorfahrt im Fahrwasser (F.60,61,70,71,34,54,61,75,68-71)
    - Sonstige Fahrregeln (F.76)
    - Ankern, Anlegen, Festmachen
- Sonstige Vorschriften
    - Schiffsunfälle, Verlust von Gegenständen (F.62,98)
    - Nord-Ostsee-Kanal (F.64-67,81)
- Schiffahrtszeichen
    - Schiffahrtszeichen (F.13)
    - Verkehrsregelnde Lichtsignale (F.67,82)
    - Tafelzeichen
Sonstige schifffahrtsrechliche Vorschriften/Bestimmungen
- See-Sportbootverordnung
- Grenzübertritt, Schiffspapiere (F.85-87, +Seemannschaft 83)
- Umweltschutz (F.101-106,108-110)
- SOLAS (F.Nav-1) 
